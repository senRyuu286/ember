        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionHeader("Your Ignition Plans", Icons.local_fire_department),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildRoutineBadge(Icons.fitness_center, "$exerciseCount exercises"),
            ],
          ),
          const SizedBox(height: 16),
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: targetMuscles.map((muscle) => _buildMuscleTag(muscle)).toList(),
          ),
